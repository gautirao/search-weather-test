import {extractWeatherInfo} from './weatherutil';

describe('weather util', () => {

    it('should extract search result correctly', function () {
        ...
        let searchResult = extractWeatherInfo( weather);

        expect(searchResult.name).toBe("London");
